...
sed "s/MACRO_FLUENTBIT_HTTP_PORT/$http_port/g; s/MACRO_FLUENTBIT_AWS_REGION/$deployment_region/g; s/MACRO_FLUENTBIT_KINESIS_STREAM/$fb_kinesis_stream/g; s/MACRO_FLUENTBIT_LOG_LEVEL/$fb_log_level/g" ${fluentbit_env_template_file}.template > $fluentbit_env_template_file
